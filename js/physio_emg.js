import * as datastreams from "./esm/index.esm.js";
const dataDevices = new datastreams.DataDevices();

// Device Driver
import ganglion from "./esm/ganglion.esm.js";
...
// UI
const physioDataView = document.querySelector("#physioDataView");

// Signal processing
import fili from "./esm/fili.esm.js";
window.filteredSample = 0;
...
const handleTrack = (track) => {
  ...
  track.subscribe((data, timestamps) => {
    ...
    window.filteredSample = filteredSample;
    physioDataView.innerHTML = filteredSample.toPrecision(4);
